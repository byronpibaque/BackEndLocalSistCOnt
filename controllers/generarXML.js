...
export default {
    ...
    xml: async (req, res, next) => {
        ...
        if(razonSocial=="MORALES VARAS NELSON GUILLERMO"){
            ...
            rutaauto=fullpath+"\\"+carpeta+"\\sri\\Autorizados\\";
            rutadevu =fullpath+"\\"+carpeta+"\\sri\\Devueltos\\";
            rutafirma =fullpath+"\\"+carpeta+"\\sri\\Firma\\ANTONIA_VANESSA_ROMERO_MONTALVAN.p12";
            executablePath = fullpath+"\\"+carpeta+"\\sri\\xadesBes\\Firma_Autorizacion.exe";
        ...
        const ruta = fullpath+"\\"+carpeta+"\\sri\\Generados\\"+p_obtener_codigo_autorizacion_desde_comprobante(estructuraFactura)+'.xml';
    ...
    xml_retencion: async (req, res, next) => {
            ...
            estructuraFactura[tipoComprobante].infoCompRetencion.dirEstablecimiento = req.body.infoCompRetencion.dirEstablecimiento;
            // estructuraFactura[tipoComprobante].infoCompRetencion.contribuyenteEspecial = '5368';
            estructuraFactura[tipoComprobante].infoCompRetencion.obligadoContabilidad = 'SI';
            estructuraFactura[tipoComprobante].infoCompRetencion.tipoIdentificacionSujetoRetenido = pad(req.body.infoCompRetencion.tipoIdentificacionSujetoRetenido, 2);
            // estructuraFactura[tipoComprobante].infoCompRetencion.guiaRemision = '001-001-000000001';
            estructuraFactura[tipoComprobante].infoCompRetencion.razonSocialSujetoRetenido = req.body.infoCompRetencion.razonSocialSujetoRetenido;
            estructuraFactura[tipoComprobante].infoCompRetencion.identificacionSujetoRetenido = req.body.infoCompRetencion.identificacionSujetoRetenido;
            estructuraFactura[tipoComprobante].infoCompRetencion.periodoFiscal = req.body.infoCompRetencion.periodoFiscal;
    
            
            estructuraFactura[tipoComprobante].infoTributaria.claveAcceso = p_obtener_codigo_autorizacion_desde_comprobanteR(estructuraFactura);
            ...
            const ruta = fullpath+"\\"+carpeta+"\\sri\\Generados\\"+p_obtener_codigo_autorizacion_desde_comprobanteR(estructuraFactura)+'.xml';
